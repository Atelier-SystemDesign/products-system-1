...
module.exports.products45 = [
  {
    id: 133,
    name: 'Michelle Shirt',
    slogan: 'Maxime aliquam eius.',
    description: 'Provident totam velit consequatur aut harum molestiae. Quia et quia voluptatem ullam quisquam. Ea nemo odio enim ab voluptas. Maxime ut ex. Et doloribus temporibus voluptas rerum aut culpa veniam ducimus et. Rerum at placeat aut ipsam consequatur quis.',
    category: 'Shirt',
    default_price: '781',
  },
  {
    id: 134,
    name: 'Lavonne Dress',
    slogan: 'Consequatur quia repudiandae rerum voluptatem.',
    description: 'Esse eum nobis molestias quia omnis. Perferendis sit incidunt quis blanditiis. Odit ut aut. Ullam excepturi qui ratione dolor cum. Minima impedit et atque dolores quidem consequatur beatae. Soluta est odio non et labore tempore consequatur rerum voluptas.',
    category: 'Dress',
    default_price: '759',
  },
  {
    id: 135,
    name: 'Stacey Shorts',
    slogan: 'Molestias porro a.',
    description: 'Maxime ullam sit fugit ut. Officiis minima et quibusdam soluta. Inventore ullam recusandae consequatur sapiente nemo.',
    category: 'Shorts',
    default_price: '927',
  },
];

module.exports.product347037 = {
  id: 347037,
  name: 'The Jaqueline Sunglasses',
  slogan: 'Praesentium eius neque praesentium iste reprehenderit odit rerum.',
  description: 'Sed omnis fugiat veritatis. Adipisci qui quia recusandae quibusdam adipisci harum enim ad. Reiciendis ut provident qui nemo quos et molestiae fugiat vitae. Atque eum aut unde et libero eligendi. Autem distinctio esse dolorum in.',
  category: 'Sunglasses',
  default_price: '729',
  features: [
    {
...
module.exports.product999986 = {
  id: 999986,
  name: 'Elenora Jacket',
  slogan: 'Voluptas sed est repellendus et quod voluptas.',
  description: 'Quasi aut voluptatem nostrum quia molestiae ut voluptatibus ratione et. Architecto omnis optio illo facilis. Adipisci ut placeat nihil ab ducimus. Et cum modi vel. Officia sed et et iure minus sunt qui blanditiis.',
  category: 'Jacket',
  default_price: '988',
  features: [
    {
